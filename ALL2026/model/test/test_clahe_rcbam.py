"""
=============================================================================
Cross-Dataset Blind Test Script — Fusion (ResNet50 + MobileNetV2) + CLAHE + RCBAM
Training set : CNMC-2019  (5-fold stratified CV)
Test set     : ALL-IDB2   (blind, never seen during training)
Model        : best_model.pth from fold_4
=============================================================================
...
MODEL_PATH   = "/home/eecommu06/Desktop/Bee/ALL/output/fusion_mobilenet_resnet_clahe_rcbam/fusion_mobilenet_resnet_clahe_rcbam_best_model.pth"
OUTPUT_DIR   = "./test/test_results/fusion_mobilenet_resnet_clahe_rcbam"
...
# ─────────────────────────────────────────────
#  CUSTOM RCBAM ATTENTION MODULES (ALIGNED TO TRAINING CHECKPOINT)
# ─────────────────────────────────────────────
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=16):
        ...
        # Grouped into a sequential block to match your training script's state_dict keys
        self.fc = nn.Sequential(
            nn.Conv2d(in_planes, in_planes // ratio, 1, bias=False),  # fc.0
            nn.ReLU(),                                                # fc.1
            nn.Conv2d(in_planes // ratio, in_planes, 1, bias=False)   # fc.2
        )
...
class SpatialAttention(nn.Module):
    def __init__(self, kernel_size=7):
        ...
        # Named 'conv1' to match your training script's state_dict keys
...
class RCBAM(nn.Module):
    """Residual Convolutional Block Attention Module"""
...
class FeatureFusionModel(nn.Module):
    def __init__(self, num_classes=2):
        ...
        # Extract features up to layer4 (spatial map)
...
print("\n" + "="*60)
print("  TEST RESULTS — Fusion (ResNet50+MobileNetV2) + CLAHE + RCBAM")
print("="*60)
...
with open(csv_path, "w", newline="") as f:
    ...
    writer.writerow(["Model", "Fusion + CLAHE + RCBAM"])
...
fig.suptitle("Confusion Matrix — Fusion Model (CLAHE+RCBAM)",
...
ax.set_title("Performance Metrics Summary — Fusion Model (CLAHE+RCBAM)",
