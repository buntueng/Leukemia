"""
=============================================================================
Cross-Dataset Blind Test Script — Fusion (ResNet50 + MobileNetV2) + CLAHE + RCBAM + CSEU
...
MODEL_PATH   = "/home/eecommu06/Desktop/Bee/ALL/output/fusion_mobilenet_resnet_clahe_rcbam_cseu/fusion_mobilenet_resnet_clahe_rcbam_cseu_best_model.pth"
OUTPUT_DIR   = "./test/test_results/fusion_mobilenet_resnet_clahe_rcbam_cseu"
...
class CSEU(nn.Module):
    """
    Channel-Spatial Excitation Unit (Concurrent sSE and cSE), 
    rebuilt exactly from your state_dict keys.
    """
    def __init__(self, in_channels, reduction=16):
        ...
        self.cSE = nn.Sequential(
            ...
            nn.Conv2d(in_channels // reduction, in_channels, 1),     # 3
            nn.Sigmoid()                                             # 4
        )
        # Spatial Squeeze and Excitation
        self.sSE = nn.Sequential(
            nn.Conv2d(in_channels, 1, 1),                            # 0
            nn.Sigmoid()                                             # 1
        )

    def forward(self, x):
        # Concurrent fusion: x * cSE + x * sSE
...
print("\n" + "="*60)
print("  TEST RESULTS — Fusion + CLAHE + RCBAM + CSEU")
print("="*60)
...
with open(csv_path, "w", newline="") as f:
    ...
    writer.writerow(["Model", "Fusion + CLAHE + RCBAM + CSEU"])
...
fig.suptitle("Confusion Matrix — Fusion Model (CLAHE+RCBAM+CSEU)",
...
ax.set_title("Performance Metrics Summary — Fusion Model (CLAHE+RCBAM+CSEU)",
