"""
=============================================================================
Cross-Dataset Blind Test Script — Fusion (ResNet50 + MobileNetV2 + CLAHE + RCBAM + EJAYA)
...
MODEL_PATH   = "/home/eecommu06/Desktop/Bee/ALL/output/fusion_mobilenet_resnet_clahe_rcbam_ejaya/fusion_mobilenet_resnet_clahe_rcbam_ejaya_best_model.pth"
OUTPUT_DIR   = "./test/test_results/fusion_mobilenet_resnet_clahe_rcbam_ejaya"  # Output directory for results
...
class FeatureFusionModel(nn.Module):
    def __init__(self, num_classes=2):
        ...
        # CSEU omitted based on instructions
        self.mobilenet_ejaya = EnhancedJAYA(1280) 
        ...
        # CSEU omitted based on instructions
        self.resnet_ejaya = EnhancedJAYA(2048) 
...
# NOTE: strict=False is used here so PyTorch ignores the CSEU weights leftover in the checkpoint
...
print("\n" + "="*60)
print("  TEST RESULTS — Fusion Model (CLAHE+RCBAM+EJAYA)")
print("="*60)
...
with open(csv_path, "w", newline="") as f:
    ...
    writer.writerow(["Model", "Fusion Model (CLAHE+RCBAM+EJAYA)"])
...
fig.suptitle("Confusion Matrix — Fusion (CLAHE+RCBAM+EJAYA)",
...
ax.set_title("Performance Metrics Summary — Fusion (CLAHE+RCBAM+EJAYA)",
...
ax.set_ylim(0, 1.18)
ax.set_ylabel("Score", fontsize=12)
ax.set_title("Per-Class Precision / Recall / F1\nFusion Model (CLAHE+RCBAM+EJAYA)",
