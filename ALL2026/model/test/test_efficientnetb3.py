"""
=============================================================================
Cross-Dataset Blind Test Script — EfficientNet-B3
...
BATCH_SIZE   = 32
NUM_WORKERS  = 4
IMG_SIZE     = 257        # EfficientNet-B3 native resolution
...
print("\n" + "="*60)
print("  TEST RESULTS — EfficientNet-B3 on ALL-IDB2")
print("="*60)
...
# ─────────────────────────────────────────────
csv_path = os.path.join(OUTPUT_DIR, "efficientnetB3_metrics_summary.csv")
with open(csv_path, "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerow(["Metric", "Value"])
    writer.writerow(["Model", "EfficientNet-B3"])
...
fig.suptitle("Confusion Matrix — EfficientNet-B3 on ALL-IDB2",
...
ax.plot(fpr, tpr, color=PALETTE["primary"], lw=2.5,
        label=f"EfficientNet-B3  (AUC = {roc_auc:.4f})")
...
ax.plot(rec_curve, prec_curve, color=PALETTE["secondary"], lw=2.5,
        label=f"EfficientNet-B3  (AP = {ap:.4f})")
...
ax.set_title("Performance Metrics Summary — EfficientNet-B3 on ALL-IDB2",
