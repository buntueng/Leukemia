"""
=============================================================================
Cross-Dataset Blind Test Script — ResNet50 (Custom Head)
...
MODEL_PATH   = "/home/eecommu06/Desktop/Bee/ALL/output/resnet50/resnet50_best_model.pth"
OUTPUT_DIR   = "./test/test_results/resnet50"
BATCH_SIZE   = 32
NUM_WORKERS  = 4
IMG_SIZE     = 257        # ResNet50 standard resolution
...
def build_model(num_classes: int = 2) -> nn.Module:
    ...
    # Rebuilding the custom classifier based on your checkpoint's exact sizes
...
print("\n" + "="*60)
print("  TEST RESULTS — ResNet50 on ALL-IDB2")
print("="*60)
...
# ─────────────────────────────────────────────
csv_path = os.path.join(OUTPUT_DIR, "resnet50_metrics_summary.csv")
with open(csv_path, "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerow(["Metric", "Value"])
    writer.writerow(["Model", "ResNet50"])
...
fig.suptitle("Confusion Matrix — ResNet50 on ALL-IDB2",
...
ax.set_title("Performance Metrics Summary — ResNet50 on ALL-IDB2",
