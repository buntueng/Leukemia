"""
=============================================================================
Cross-Dataset Blind Test Script — Fusion Model + CLAHE
...
MODEL_PATH   = "/home/eecommu06/Desktop/Bee/ALL/output/fusion_mobilenet_resnet_clahe/fusion_mobilenet_resnet_clahe_best_model.pth"
OUTPUT_DIR   = "./test/test_results/fusion_mobilenet_resnet_clahe"
...
test_transform = transforms.Compose([
    ApplyCLAHE(clip_limit=2.0, tile_grid_size=(8, 8)), # Added CLAHE pre-processing
...
# ─────────────────────────────────────────────
#  MODEL ARCHITECTURE (Matches new fusion.py)
# ─────────────────────────────────────────────
...
print("\n" + "="*60)
print("  TEST RESULTS — Fusion (ResNet50 + MobileNetV2) + CLAHE")
print("="*60)
...
with open(csv_path, "w", newline="") as f:
    ...
    writer.writerow(["Model", "Fusion + CLAHE"])
...
fig.suptitle("Confusion Matrix — Fusion Model (CLAHE)",
...
ax.set_title("Performance Metrics Summary — Fusion Model (CLAHE)",
